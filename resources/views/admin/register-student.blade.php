...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('admin.create_student') }}" method="post" class="needs-validation" novalidate>
            @csrf
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="invalid-feedback">Mohon isi email untuk akun siswa</div>
                </div>
                <div class="col-md-6">
                    <label for="password">Password <span class="text-danger">*</span></label>
                    <input type="text" name="password" id="password" class="form-control" required>
                    <div class="invalid-feedback">Mohon isi password untuk akun siswa</div>
                </div>
            </div>
            <!-- Student Information -->
            <div class="row">
